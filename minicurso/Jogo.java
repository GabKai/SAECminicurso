...
public class Jogo extends JPanel implements Runnable{
    ...
    public Jogo(){        
        ...
        this.jogador = new Personagem(this, Color.blue, 200, 200, 32, 32, 3);
    ...
    public boolean colisao(Personagem personagem){
        if(personagem.getX() < 0 || personagem.getY() < 0 || (personagem.getX() + personagem.getWidth()) > Programa.screenWidth
         || (personagem.getY() + personagem.getHeigth()) > Programa.screenHeigth){
            return false;
        }
        return true;
    }
    ...
    public void novoInimigo(){
        ...
        this.inimigos.add(new Inimigo(this, Color.red, rx, ry, width, height, 2));
    }
